...
| `oap.image.tag`                                              | OAP container image tag                                                                          | `8.0.0-es7`                              |
...
| `oap.javaOpts`                                               | Parameters to be added to `JAVA_OPTS`environment variable for OAP                                | `-Xms1g -Xmx1g`                      |
...
| `ui.image.tag`                                               | Web UI container image tag                                                                       | `8.0.0`                              |
